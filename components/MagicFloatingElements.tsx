...
const IMAGES = [
  ...
  { src: '/personajes/img1.jpeg', size: 'w-32 h-32 md:w-48 md:h-48', top: '60%', left: '5%', z: 'z-[60]', delay: 1, speed: 0.8, parallax: 150, rotate: -15 },
  { src: '/personajes/img2.jpeg', size: 'w-20 h-20 md:w-28 md:h-28', top: '80%', left: '40%', z: 'z-[20]', delay: 2, speed: 1.5, parallax: -50, rotate: 5 },
  { src: '/personajes/img3.jpeg', size: 'w-40 h-40 md:w-56 md:h-56', top: '20%', right: '-5%', z: 'z-[60]', delay: 3, speed: 0.6, parallax: 200, rotate: 20 },
  { src: '/personajes/img4.jpeg', size: 'w-16 h-16 md:w-24 md:h-24', top: '40%', right: '25%', z: 'z-[5]', delay: 0.5, speed: 2, parallax: -30, rotate: -10 },
...
function FloatingImage({ 
  ...
  // Safe to call hooks here because it's inside a valid React component
