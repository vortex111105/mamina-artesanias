...
export function ProductDetailView({ product }: { product: Product }) {
  ...
  const IG_USERNAME = process.env.NEXT_PUBLIC_IG_USERNAME || 'mamina.artesanias'
        ...
        <div className="w-full md:w-1/2 shrink-0">
          <div className="relative aspect-square rounded-[2rem] overflow-hidden bg-white/40 shadow-warm-lg border border-white/60">
            ...
            <div className="absolute top-4 left-4">
              <span className={`text-xs font-bold px-4 py-2 rounded-full shadow-md backdrop-blur-md ${
